...
CREATE TABLE IF NOT EXISTS tblDeniro
(
...
INSERT INTO tblDeniro
VALUES (1968, 86, ' "Greetings"'),
       (1970, 73, ' "Hi, Mom!"'),
       (1971, 40, ' "Born to Win"'),
       ...
       (1993, 75, ' "This Boys Life"'),
       (1993, 78, ' "Mad Dog and Glory"'),
       (1993, 96, ' "A Bronx Tale"'),
       (1994, 39, ' "Mary Shelley Frankenstein"'),
       (1995, 80, ' "Casino"'),
       (1995, 86, ' "Heat"'),
       (1996, 74, ' "Sleepers"'),
       (1996, 38, ' "The Fan"'),
       ...
       (2009, 46, ' "Everybodys Fine"'),
       (2010, 72, ' "Machete"'),
       (2010, 10, ' "Little Fockers"'),
       (2010, 50, ' "Stone"'),
       (2011, 25, ' "Killer Elite"'),
       (2011, 7, ' "New Years Eve"'),
       (2011, 70, ' "Limitless"'),
